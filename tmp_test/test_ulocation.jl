...
printstyled("\n\nTest 6: @nospecialize with where {T<:IDS}\n", bold=true)
...
printstyled("\n\nTest 7: Wrapper WITHOUT @nospecialize\n", bold=true)
...
printstyled("\n\nTest 8: @noinline without @nospecialize\n", bold=true)
...
printstyled("\n\nTest 9: @constprop :none @noinline without @nospecialize\n", bold=true)
...
# ## Last Test
printstyled("\n\nTest 9: Practical case (loading HDF5 file)\n", bold=true)

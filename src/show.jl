...
@nospecializeinfer function AbstractTrees.children(@nospecialize(ids::IDS))
    ns = NoSpecialize(ids)
    return (IMASnodeRepr(ns.ids, field, getraw(ns.ids, field)) for field in keys_no_missing(ns.ids))
end

@nospecializeinfer function AbstractTrees.children(@nospecialize(ids::IDSvector))
    return ids
end

@nospecializeinfer function AbstractTrees.children(@nospecialize(node_value::IMASnodeRepr))
...
@nospecializeinfer function AbstractTrees.printnode(io::IO, @nospecialize(ids::IDS))
    return printstyled(io, f2p_name(ids); bold=true)
end

@nospecializeinfer function AbstractTrees.printnode(io::IO, @nospecialize(ids::IDSvector))
    return printstyled(io, f2p_name(ids); bold=true)
end

@nospecializeinfer function AbstractTrees.printnode(io::IO, @nospecialize(node_value::IMASnodeRepr))
    ids = node_value.ids
...
@nospecializeinfer function Base.show(io::IO, @nospecialize(ids_arr::AbstractArray{<:IDS}); maxdepth::Int=1000, kw...)
...
@nospecializeinfer function Base.show(io::IO, @nospecialize(ids_arr::AbstractArray{<:IDSvector}); maxdepth::Int=1000, kw...)
    for (i, ids) in enumerate(ids_arr)
        print(io, "\n" * "="^15 * " Item #$(i) " * "="^15 * "\n")
        AbstractTrees.print_tree(io, ids; maxdepth, kw...)
    end
...
@nospecializeinfer function Base.show(io::IO, @nospecialize(ids::Union{IDS,IDSvector}); maxdepth::Int=1000, kw...)
...
@nospecializeinfer function Base.show(io::IO, ::MIME"text/plain", @nospecialize(ids::Union{IDS,IDSvector}); maxdepth::Int=1000, kw...)
...
@nospecializeinfer function Base.show(io::IO, ::MIME"text/plain", @nospecialize(ids_arr::AbstractArray{<:IDS}); maxdepth::Int=1000, kw...)
    return show(io, ids_arr; maxdepth, kw...)
end

@nospecializeinfer function Base.show(io::IO, ::MIME"text/plain", @nospecialize(ids_arr::AbstractArray{<:IDSvector}); maxdepth::Int=1000, kw...)
    return show(io, ids_arr; maxdepth, kw...)
end

# show function for inline prints
@nospecializeinfer function Base.show(io::IO, @nospecialize(ids::IDS))
...
@nospecializeinfer function Base.show(@nospecialize(ids::Union{IDS,IDSvector}), maxdepth; kw...)
    return AbstractTrees.print_tree(ids; maxdepth, kw...)
end

# show function for inline prints
@nospecializeinfer function Base.show(io::IO, @nospecialize(ids::IDSvector))
...
@nospecializeinfer function print_formatted_node(io::IO, nodename::String, @nospecialize(nfo::Info); color::Symbol, bold::Bool)
...
@nospecializeinfer function AbstractTrees.printnode(io::IO, @nospecialize(leaf::IMASstructRepr); kw...)
    nfo = info(leaf.location)
    print_formatted_node(io, string(leaf.field), nfo; color=:red, bold=false)
    return nothing
end

@nospecializeinfer function AbstractTrees.printnode(io::IO, @nospecialize(ids_type::Type{<:IDS}); kw...)
...
@nospecializeinfer function AbstractTrees.printnode(io::IO, @nospecialize(ids_type::Type{<:IDSvector}); kw...)
...
@nospecializeinfer function AbstractTrees.children(@nospecialize(ids_type::Type{<:IDS}); kw...)
    tmp = []
...
@nospecializeinfer function AbstractTrees.children(@nospecialize(ids_type::Type{<:IDSvector}); kw...)
    return AbstractTrees.children(eltype(ids_type); kw...)
end

@nospecializeinfer function AbstractTrees.Leaves(@nospecialize(ids_type::Type{<:IDS}))
    tmp = IMASstructRepr[]
    for (field, field_type) in zip(fieldnames(ids_type), fieldtypes(ids_type))
...
@nospecializeinfer function AbstractTrees.Leaves(@nospecialize(ids_type::Type{<:IDSvector}); kw...)
    return AbstractTrees.Leaves(eltype(ids_type); kw...)
end

@nospecializeinfer function help(@nospecialize(ids_type::Type{<:Union{IDS,IDSvector}}); maxdepth::Int=1000, kw...)
    return AbstractTrees.print_tree(ids_type; maxdepth, kw...)
end

@nospecializeinfer function help(@nospecialize(ids::Union{IDS,IDSvector}); maxdepth::Int=1000, kw...)
